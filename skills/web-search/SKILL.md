...
## Description
Performs web searches and returns results using the ddgr command-line tool.
...
This skill uses the `exec` tool to run ddgr commands.

## Examples

- "web search Samsung S26 price Bangladesh"
- "web search Python tutorial"
- "web search latest news"

## Implementation

When user requests a web search:
1. Extract the search query
2. Run: `ddgr --np -n 5 "[query]"`
--
